...
out_dir = "/scratch/ProjectDir/output/pysam_regions/unmapped"
...
for num, bam_file in enumerate(bam_files):
    print("Doing: ", num+1, "/", total_files, "         (", bam_file,")", end="\r")
...
tel_bam_files = os.listdir(out_dir)
tel_bam_files = [f for f in tel_bam_files if f.endswith(".bam")]
#for num, bam_file in enumerate(tel_bam_files):
